...
class TestConsole(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        #     HBNBConsole().onecmd("? show")
        #     self.assertIsInstance(f.getvalue(), str)
        #     self.assertEqual(f.getvalue().strip(), msg)

        # with patch('sys.stdout', new=StringIO()) as f:
        #     msg = "Prints the string representation of an instance."
        #     HBNBConsole().onecmd("help show")
        #     self.assertIsInstance(f.getvalue(), str)
        #     self.assertEqual(f.getvalue().strip(), msg)

        # with patch('sys.stdout', new=StringIO()) as f:
        #     msg = "Updates an instance based on the class name and id."
        #     HBNBConsole().onecmd("? update")
        #     self.assertIsInstance(f.getvalue(), str)
        #     self.assertEqual(f.getvalue().strip(), msg)

        # with patch('sys.stdout', new=StringIO()) as f:
        #     msg = "Updates an instance based on the class name and id."
        #     HBNBConsole().onecmd("help update")
        #     self.assertIsInstance(f.getvalue(), str)
        #     self.assertEqual(f.getvalue().strip(), msg)

        # with patch('sys.stdout', new=StringIO()) as f:
        #     msg = "Deletes an instance based on the class name and id."
        #     HBNBConsole().onecmd("? destroy")
        #     self.assertIsInstance(f.getvalue(), str)
        #     self.assertEqual(f.getvalue().strip(), msg)

        # with patch('sys.stdout', new=StringIO()) as f:
        #     msg = "Deletes an instance based on the class name and id."
        #     HBNBConsole().onecmd("help destroy")
        #     self.assertIsInstance(f.getvalue(), str)
        #     self.assertEqual(f.getvalue().strip(), msg)
        ...
        #     self.assertIsInstance(f.getvalue(), str)
        #     self.assertEqual(
        #         f.getvalue().strip(), "Quit command to exit the program."
        #     )
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_all_basemodel(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBConsole().onecmd('all BaseModel')
    ...
    def test_show_basemodel(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            b1 = BaseModel()
            b1.eyes = "green"
            HBNBConsole().onecmd(f'show BaseModel {b1.id}')
    ...
    def test_update_basemodel(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            b1 = BaseModel()
            b1.name = "Cecilia"
            HBNBConsole().onecmd(f'update BaseModel {b1.id} name "Ife"')
            self.assertEqual(b1.__dict__["name"], "Ife")

        with patch('sys.stdout', new=StringIO()) as f:
            b1 = BaseModel()
            b1.age = 75
            HBNBConsole().onecmd(f'update BaseModel {b1.id} age 25')
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            b1 = BaseModel()
            b1.savings = 25.67
            HBNBConsole().onecmd(f'update BaseModel {b1.id} savings 35.89')
    ...
    def test_destroy_basemodel(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            bm = BaseModel()
            HBNBConsole().onecmd(f'destroy BaseModel {bm.id}')
...
class TestUser(unittest.TestCase):
    ...
    def test_show_user(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            us = User()
            us.eyes = "green"
            HBNBConsole().onecmd(f'show User {us.id}')
    ...
    def test_update_user(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            us = User()
            us.name = "Cecilia"
            HBNBConsole().onecmd(f'update User {us.id} name "Ife"')
            self.assertEqual(us.__dict__["name"], "Ife")

        with patch('sys.stdout', new=StringIO()) as f:
            us = User()
            us.age = 75
            HBNBConsole().onecmd(f'update User {us.id} age 25')
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            us = User()
            us.savings = 25.67
            HBNBConsole().onecmd(f'update User {us.id} savings 35.89')
    ...
    def test_destroy_user(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            us = User()
            HBNBConsole().onecmd(f'destroy User {us.id}')
...
class TestState(unittest.TestCase):
    ...
    def test_show_state(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            st = State()
            st.eyes = "green"
            HBNBConsole().onecmd(f'show State {st.id}')
    ...
    def test_update_state(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            st = State()
            st.name = "Cecilia"
            HBNBConsole().onecmd(f'update State {st.id} name "Ife"')
            self.assertEqual(st.__dict__["name"], "Ife")

        with patch('sys.stdout', new=StringIO()) as f:
            st = State()
            st.age = 75
            HBNBConsole().onecmd(f'update State {st.id} age 25')
    ...
    def test_destroy_state(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            st = State()
            HBNBConsole().onecmd(f'destroy State {st.id}')
...
class TestReview(unittest.TestCase):
    ...
    def test_show_review(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            rv = Review()
            rv.eyes = "green"
            HBNBConsole().onecmd(f'show Review {rv.id}')
    ...
    def test_update_review(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            rv = Review()
            rv.name = "Cecilia"
            HBNBConsole().onecmd(f'update Review {rv.id} name "Ife"')
            self.assertEqual(rv.__dict__["name"], "Ife")

        with patch('sys.stdout', new=StringIO()) as f:
            rv = Review()
            rv.age = 75
            HBNBConsole().onecmd(f'update Review {rv.id} age 25')
    ...
    def test_destroy_review(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            rv = Review()
            HBNBConsole().onecmd(f'destroy Review {rv.id}')
...
class TestPlace(unittest.TestCase):
    ...
    def test_show_place(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            pl = Place()
            pl.eyes = "green"
            HBNBConsole().onecmd(f'show Place {pl.id}')
    ...
    def test_update_place(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            pl = Place()
            pl.name = "Cecilia"
            HBNBConsole().onecmd(f'update Place {pl.id} name "Ife"')
            self.assertEqual(pl.__dict__["name"], "Ife")

        with patch('sys.stdout', new=StringIO()) as f:
            pl = Place()
            pl.age = 75
            HBNBConsole().onecmd(f'update Place {pl.id} age 25')
    ...
    def test_destroy_place(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            pl = Place()
            HBNBConsole().onecmd(f'destroy Place {pl.id}')
...
class TestAmenity(unittest.TestCase):
    ...
    def test_all_amenity(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBConsole().onecmd('all Amenity')
            for item in json.loads(f.getvalue()):
    ...
    def test_show_amenity(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            am = Amenity()
            am.eyes = "green"
            HBNBConsole().onecmd(f'show Amenity {am.id}')
    ...
    def test_update_amenity(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            am = Amenity()
            am.name = "Cecilia"
            HBNBConsole().onecmd(f'update Amenity {am.id} name "Ife"')
            self.assertEqual(am.__dict__["name"], "Ife")

        with patch('sys.stdout', new=StringIO()) as f:
            am = Amenity()
            am.age = 75
            HBNBConsole().onecmd(f'update Amenity {am.id} age 25')
    ...
    def test_destroy_amenity(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            am = Amenity()
            HBNBConsole().onecmd(f'destroy Amenity {am.id}')
...
class TestCity(unittest.TestCase):
    ...
    def test_show_city(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            cty = City()
            cty.eyes = "green"
            HBNBConsole().onecmd(f'show City {cty.id}')
    ...
    def test_update_city(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            cty = City()
            cty.name = "Cecilia"
            HBNBConsole().onecmd(f'update City {cty.id} name "Ife"')
            self.assertEqual(cty.__dict__["name"], "Ife")

        with patch('sys.stdout', new=StringIO()) as f:
            cty = City()
            cty.age = 75
            HBNBConsole().onecmd(f'update City {cty.id} age 25')
    ...
    def test_destroy_city(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            cty = City()
            HBNBConsole().onecmd(f'destroy City {cty.id}')
