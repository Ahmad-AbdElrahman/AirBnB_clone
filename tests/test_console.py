...
class TestBaseModelDotNotation(unittest.TestCase):
    ...
    def test_show_basemodel(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            b1.eyes = "green"
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'BaseModel.show({b1.id})')
            )
            res = f"[{type(b1).__name__}] ({b1.id}) {b1.__dict__}"
            self.assertEqual(f.getvalue().strip(), res)
    ...
    def test_update_basemodel(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            b1.name = "Cecilia"
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'BaseModel.update({b1.id}, name, "Ife")')
            )
            self.assertEqual(b1.__dict__["name"], "Ife")
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            b1.age = 75
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'BaseModel.update({b1.id}, age, 25)')
            )
            self.assertIn("age", b1.__dict__.keys())
            self.assertEqual(b1.__dict__["age"], 25)
    ...
    def test_destroy_basemodel(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            bm = BaseModel()
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'BaseModel.destroy({bm.id})')
            )
            self.assertNotIn("BaseModel.{}".format(bm.id), storage.all().keys())
...
class TestUserDotNotation(unittest.TestCase):
    ...
    def test_update_user(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            us.name = "Cecilia"
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'User.update({us.id}, name, "Ife")')
            )
            self.assertEqual(us.__dict__["name"], "Ife")
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            us.age = 75
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'User.update({us.id}, age, 25)')
            )
            self.assertIn("age", us.__dict__.keys())
            self.assertEqual(us.__dict__["age"], 25)
    ...
    def test_destroy_user(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            us = User()
            HBNBCommand().onecmd(HBNBCommand().precmd(f'User.destroy({us.id})'))
            self.assertNotIn("User.{}".format(us.id), storage.all().keys())
...
class TestStateDotNotation(unittest.TestCase):
    ...
    def test_show_state(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            st = State()
            st.eyes = "green"
            HBNBCommand().onecmd(HBNBCommand().precmd(f'State.show({st.id})'))
            res = f"[{type(st).__name__}] ({st.id}) {st.__dict__}"
            self.assertEqual(f.getvalue().strip(), res)
    ...
    def test_update_state(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            st.name = "Cecilia"
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'State.update({st.id}, name, "Ife")')
            )
            self.assertEqual(st.__dict__["name"], "Ife")
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            st.age = 75
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'State.update({st.id}, age, 25)')
            )
            self.assertIn("age", st.__dict__.keys())
            self.assertEqual(st.__dict__["age"], 25)
    ...
    def test_destroy_state(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            st = State()
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'State.destroy({st.id})')
            )
            self.assertNotIn("State.{}".format(st.id), storage.all().keys())
...
class TestReviewDotNotation(unittest.TestCase):
    ...
    def test_show_review(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            rv = Review()
            rv.eyes = "green"
            HBNBCommand().onecmd(HBNBCommand().precmd(f'Review.show({rv.id})'))
            res = f"[{type(rv).__name__}] ({rv.id}) {rv.__dict__}"
            self.assertEqual(f.getvalue().strip(), res)
    ...
    def test_update_review(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            rv.name = "Cecilia"
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'Review.update({rv.id}, name, "Ife")')
            )
            self.assertEqual(rv.__dict__["name"], "Ife")
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            rv.age = 75
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'Review.update({rv.id}, age, 25)')
            )
            self.assertIn("age", rv.__dict__.keys())
            self.assertEqual(rv.__dict__["age"], 25)
    ...
    def test_destroy_review(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            rv = Review()
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'Review.destroy({rv.id})')
            )
            self.assertNotIn("Review.{}".format(rv.id), storage.all().keys())
...
class TestPlaceDotNotation(unittest.TestCase):
    ...
    def test_show_place(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            pl = Place()
            pl.eyes = "green"
            HBNBCommand().onecmd(HBNBCommand().precmd(f'Place.show({pl.id})'))
            res = f"[{type(pl).__name__}] ({pl.id}) {pl.__dict__}"
            self.assertEqual(f.getvalue().strip(), res)
    ...
    def test_update_place(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            pl.name = "Cecilia"
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'Place.update({pl.id}, name, "Ife")')
            )
            self.assertEqual(pl.__dict__["name"], "Ife")
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            pl.age = 75
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'Place.update({pl.id}, age, 25)')
            )
            self.assertIn("age", pl.__dict__.keys())
            self.assertEqual(pl.__dict__["age"], 25)
    ...
    def test_destroy_place(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            pl = Place()
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'Place.destroy({pl.id})')
            )
            self.assertNotIn("Place.{}".format(pl.id), storage.all().keys())
...
class TestAmenityDotNotation(unittest.TestCase):
    ...
    def test_show_amenity(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            am = Amenity()
            am.eyes = "green"
            HBNBCommand().onecmd(HBNBCommand().precmd(f'Amenity.show({am.id})'))
            res = f"[{type(am).__name__}] ({am.id}) {am.__dict__}"
            self.assertEqual(f.getvalue().strip(), res)
    ...
    def test_update_amenity(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            am.name = "Cecilia"
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'Amenity.update({am.id}, name, "Ife")')
            )
            self.assertEqual(am.__dict__["name"], "Ife")
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            am.age = 75
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'Amenity.update({am.id}, age, 25)')
            )
            self.assertIn("age", am.__dict__.keys())
            self.assertEqual(am.__dict__["age"], 25)
    ...
    def test_destroy_amenity(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            am = Amenity()
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'Amenity.destroy({am.id})')
            )
            self.assertNotIn("Amenity.{}".format(am.id), storage.all().keys())
...
class TestCityDotNotation(unittest.TestCase):
    ...
    def test_show_city(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            cty = City()
            cty.eyes = "green"
            HBNBCommand().onecmd(HBNBCommand().precmd(f'City.show({cty.id})'))
            res = f"[{type(cty).__name__}] ({cty.id}) {cty.__dict__}"
            self.assertEqual(f.getvalue().strip(), res)
    ...
    def test_update_city(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            cty.name = "Cecilia"
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'City.update({cty.id}, name, "Ife")')
            )
            self.assertEqual(cty.__dict__["name"], "Ife")
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            cty.age = 75
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'City.update({cty.id}, age, 25)')
            )
            self.assertIn("age", cty.__dict__.keys())
            self.assertEqual(cty.__dict__["age"], 25)
    ...
    def test_destroy_city(self):
        ...
        with patch('sys.stdout', new=StringIO()):
            cty = City()
            HBNBCommand().onecmd(
                HBNBCommand().precmd(f'City.destroy({cty.id})')
            )
            self.assertNotIn("City.{}".format(cty.id), storage.all().keys())
